...
internal static class D3DUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GpuPreference ToDXGI(PowerPreference powerPreference)
    {
        return powerPreference switch
        {
            PowerPreference.HighPerformance => GpuPreference.HighPerformance,
            PowerPreference.LowPower => GpuPreference.MinimumPower,
